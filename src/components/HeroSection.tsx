      ...
      <div className="relative z-10 container-xl px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in">
            A nova forma de consumir{" "}
            <span className="text-secondary-light">energia limpa</span>{" "}
            chegou.
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto animate-slide-up">
            Qualquer pessoa pode economizar usando energia solar compartilhada, 
            sem obras, sem investimento inicial e sem complicação.
          </p>
